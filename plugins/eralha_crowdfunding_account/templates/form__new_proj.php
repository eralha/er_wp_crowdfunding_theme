	...
	<form name="registerForm" id="registerForm" action="{REQUEST_URI}" method="post" class="{hidde_form}" enctype="multipart/form-data">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<p class="help-block">
					Nivel de recompensas e respectiva descrição que os doadores irão ter, por exp:<br />
					1€ : Ter o nome na página de agradecimentos.<br />
					10€ : Ganha subscrição do serviço por 1 mês.<br />
					etc...
				</p>
			</div>
			<div class="form-group">
